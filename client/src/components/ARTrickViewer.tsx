...
export function ARTrickViewer({
  ...
  return (
    <Card
      className={`bg-neutral-900/50 border-success/50 ${className}`}
    ...
    >
      ...
      <CardContent className="space-y-4">
        <div className="aspect-video bg-gradient-to-br from-success/30 to-neutral-950 rounded-lg flex items-center justify-center border border-success/30">
          <div className="text-center text-gray-400">
            <Camera className="w-12 h-12 mx-auto mb-2 text-success" />
        ...
        <Button
          ...
          className="w-full gap-2 bg-success hover:bg-success-hover text-white"
